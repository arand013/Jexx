...
import Logos from "./images/JEXX-LOGO.png"
...
const styles = {
  content: {
    ...
    marginTop: "130px",
    padding: "10px",
    background: "linear-gradient(to left, #a39273fa, #4754a1)",
  },
  header: {
    position: "fixed",
    zIndex: 1,
...
export const Logo = () => (
  <div style={{ display: "flex" }}>
     <img src={Logos} alt="React Logo" width="60" height="45" viewBox="0 0 10 10" />
